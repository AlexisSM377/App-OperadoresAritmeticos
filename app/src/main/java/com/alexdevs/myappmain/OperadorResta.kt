...
class OperadorResta : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_operador_resta)

        val numero1 = findViewById<EditText>(R.id.numero1)
        val numero2 = findViewById<EditText>(R.id.numero2)
        val btnResta = findViewById<MaterialButton>(R.id.Btn_resta)
        ...
        btnResta.setOnClickListener {
            ...
            if (num1 != null && num2 != null) {
                val resta = num1 - num2
                resultado.text = getString(R.string.resultadoR, resta.toString())
            } else {
